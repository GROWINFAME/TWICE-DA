...
class DeformableMultiheadAttention(nn.Module):
    def __init__(self,
        ...
        self.offset_generator = MultiScaleOffsetGenerator2D(offset_dim=offset_dim,
                                                            offset_kernel_sizes=self.generate_offset_kernel_sizes(offset_scale),
    ...
    def forward(self, x):
        ...
        group = lambda t: rearrange(t, "b (h w) (g c) -> (b g) c h w", h=h, w=w, g=self.offset_groups)
